...
export class MetaDialogueComponent implements OnInit  {
  itemMeta: TMMeta;
  metaForm: FormGroup;
  ...
  constructor(private dialogRef: MatDialogRef<MetaDialogueComponent>, @Inject(MAT_DIALOG_DATA) public data: any, private profileService: ProfileService) {
    ...
    this.itemMeta.bbox = data.bbox;
    this.itemMeta.mapboxid = data.id;
  }

  ngOnInit() {
    this.metaForm = new FormGroup({
      name: new FormControl(this.itemMeta.name ? this.itemMeta.name : '', [Validators.required]),
      type: new FormControl(this.itemMeta.type ? this.itemMeta.type : '', [Validators.required]),
      country: new FormControl(this.itemMeta.country ? this.itemMeta.country : '', [Validators.required]),
      continent: new FormControl(this.itemMeta.continent ? this.itemMeta.continent : '', [Validators.required]),
      sourceurl: new FormControl(this.itemMeta.sourceUrl ? this.itemMeta.sourceUrl : '', [
        Validators.required,
        Validators.pattern(
  ...
  saveMeta() {
    ...
    this.itemMeta.country = res.country;
    this.itemMeta.name = res.name;
    this.itemMeta.sourceDate = res.sourcedate;
    this.itemMeta.sourceUrl = res.sourceurl;
    this.itemMeta.type = res.type;
